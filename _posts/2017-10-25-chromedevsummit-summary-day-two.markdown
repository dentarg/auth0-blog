...
Tal shared how many of the quickly growing countries still have data costs above 5% GNI. According to Tal, _fifty-three percent of mobile connections will still be 2G in India in 2020._ She talked about how PWA reduces the install size of an app and used the _OLA_ service as a case study.
