...
Furthermore, there will be a second part to this article which demonstrates how to make the application work offline - we're going to make a Progressive Web App.
