...
description: Learn how to automate time-consuming tasks in your development workflow with Gulp.
date: 2017-10-12 8:30
category: Technical Guide, JavaScript, Gulp
author:
...
**TL;DR:** In this tutorial, I'll show you how easy it is to automate your development workflow with GulpJS. Check out the [repo](https://github.com/auth0-blog/firebase-phone-auth) to get the code.
