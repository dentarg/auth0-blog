...
description: "Creating high quality NPM packages to share with the community is not hard. It's all about configuring the right tools to helps us develop trustworthy libraries. Let's learn, through a practical exercise, what tools we can leverage are and how to configure them."
...
> What is nice about about ESLint is that it also enables us to adhere to popular style guides (in this case [the Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript)). There are other popular styles available to JavaScript developers and we could even create our own. However, to play safe, we will stick to an existing and popular one.
...
{% include tweet_quote.html quote_text="Linting tools can help us identify potential errors on our code." %}
...
- [**Jasmine**: a platform-agnostic test framework](https://jasmine.github.io/) that contains 13.1 thousand stars on GitHub and was downloaded 22 million times during 2017;
